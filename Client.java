...
/*
ob class, have an arraylist of jobs loaded up and it will send them one at a time to the master
For now, we’ll hardcode the jobs. The client will take those, a thread will send it to the master. We need one main
*/
